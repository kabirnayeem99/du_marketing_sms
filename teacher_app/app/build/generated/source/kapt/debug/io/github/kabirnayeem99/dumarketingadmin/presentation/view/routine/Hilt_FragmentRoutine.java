...
public abstract class Hilt_FragmentRoutine<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentRoutine_GeneratedInjector) this.generatedComponent()).injectFragmentRoutine(UnsafeCasts.<FragmentRoutine>unsafeCast(this));
    }
  }
