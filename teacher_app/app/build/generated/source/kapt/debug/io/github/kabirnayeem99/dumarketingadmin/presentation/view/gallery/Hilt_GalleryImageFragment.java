...
public abstract class Hilt_GalleryImageFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GalleryImageFragment_GeneratedInjector) this.generatedComponent()).injectGalleryImageFragment(UnsafeCasts.<GalleryImageFragment>unsafeCast(this));
    }
  }
