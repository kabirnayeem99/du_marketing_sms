...
public abstract class Hilt_EbookFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EbookFragment_GeneratedInjector) this.generatedComponent()).injectEbookFragment(UnsafeCasts.<EbookFragment>unsafeCast(this));
    }
  }
