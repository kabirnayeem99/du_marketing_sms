 ...
 */
public abstract class Hilt_UpsertRoutineFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpsertRoutineFragment_GeneratedInjector) this.generatedComponent()).injectUpsertRoutineFragment(UnsafeCasts.<UpsertRoutineFragment>unsafeCast(this));
    }
  }
