...
public abstract class Hilt_UploadEbookFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UploadEbookFragment_GeneratedInjector) this.generatedComponent()).injectUploadEbookFragment(UnsafeCasts.<UploadEbookFragment>unsafeCast(this));
    }
  }
