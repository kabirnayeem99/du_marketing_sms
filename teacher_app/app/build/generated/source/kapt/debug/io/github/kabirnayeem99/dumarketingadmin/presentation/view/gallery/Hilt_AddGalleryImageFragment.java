...
public abstract class Hilt_AddGalleryImageFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddGalleryImageFragment_GeneratedInjector) this.generatedComponent()).injectAddGalleryImageFragment(UnsafeCasts.<AddGalleryImageFragment>unsafeCast(this));
    }
  }
